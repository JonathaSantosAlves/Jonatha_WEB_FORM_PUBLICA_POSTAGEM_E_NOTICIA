            ...
            <div class="col-lg-3">
                ...
                <div class="card">
                    <div class="border">
                        <h5 style="font-size: 2.8vmin">
                            <span class="badge rounded-pill bg-primary">
                                <i class="far fa-user-circle"></i>Publicado por: <%=noticia_item.USUARIO%>
                            </span><small><span class="text-end"><%=Convert.ToDateTime(noticia_item.DATA_REGISTRO).ToString("dd-MM-yyyy")%></span></small>
                        </h5>

                        <div class="card-header">
                            <h2 style="font-size: 2.8vmin; text-align: center">
                                <span class=""><%=noticia_item.TITULO%>
                                </span>
                            </h2>
                        </div>
                        <div class="card-body">
                            <% If noticia_item.TIPO = "IMAGEM" Then %>
                            <center>
                                <img src="<%=noticia_item.ARQUIVO%>" class="img-fluid" alt="...">
                            </center>
                            <% End If %>
                            <% If noticia_item.TIPO = "VIDEO" Then %>
                            <center>
                                <div class="ratio ratio-21x9">
                                    <video controls>
                                        <source src="<%=noticia_item.ARQUIVO%>" type="video/mp4">
                                        Your browser does not support the video tag.
                                    </video>
                                </div>
                            </center>
                            <% End If %>
                            <% If noticia_item.TIPO = "YOUTUBE" Then %>
                            <center>
                                <div class="ratio ratio-21x9">
                                    <iframe src="<%=noticia_item.ARQUIVO%>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                </div>
                            </center>
                            <% End If %>
                        </div>

<%@ Page ValidateRequest="false" Debug="true" Async="true" Title="Home Page" Language="vb" MasterPageFile="~/Views/Shared/Site.Master" AutoEventWireup="false" CodeBehind="Noticias_Alterar.aspx.vb" Inherits="Jonatha_WEB_FORM_VB_POSTAGEM_E_NOTICIAS_UI.Noticias_Alterar" %>
                ...
                <div class="container">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            ...
                            - Alterar uma Noticia</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" arial-label="Close" onclick="location.href='../Noticias/Noticias_Pagina_Inicial.aspx'"></button>
                    </div>
